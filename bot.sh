...
while IFS= read -r line; do
    ...
    #curl -A "Bot_agungsurya/5.0 (Windows NT 6.1; Win64; x64; rv:59.0) Gecko/20100101 Bot/59.0" http://localhost
      status_code=$(curl --connect-timeout 180 --retry 2 --write-out %{http_code} --silent --output /dev/null -A "Bot_website_check/5.0 (Ubuntu Server 20.04.4 at 172.16.121.134; x86; x64; rv:59.0) Gecko/20100101 Bot/59.0" -L ${protokol}${line})
      sleep $[ ( $RANDOM % 3 )  + 1 ]s
